...
const showMillionairesButton = document.getElementById("show-millionaries");
...
async function genrateRandomUser() {
...
addUserButton.addEventListener("click", genrateRandomUser);
